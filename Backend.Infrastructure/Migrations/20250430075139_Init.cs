        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainPot = table.Column<int>(type: "int", nullable: false),
                    CurrentRoundPot = table.Column<int>(type: "int", nullable: false),
                    FirstPlayerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PivotPlayerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CurrentPlayerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SkipActions = table.Column<bool>(type: "bit", nullable: false),
                    BigBlindAmount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentGameAction = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasToRevealCards = table.Column<bool>(type: "bit", nullable: false),
                    BlindStatus = table.Column<int>(type: "int", nullable: false),
